...
function Footer() {
    return (
        <>{/* <!-- start footer --> */}
                <div className="hidden md:flex justify-evenly font-medium text-green-600 py-3 mt-0 bg-gray-900 border-b ">
            ...
            <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                        <h3 className="font-bold text-2xl">Asean Plant Export</h3>
                        <p className="text-gray-400">Asia most best plant sellers.</p>
                    ...
                    <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                        ...
                        <p className="text-sm text-gray-400 mt-12">© 2023 🌱 Asean Plant Export <br className="hidden lg:block" />All Rights Reserved..
                        </p>
                    </div>
                </div>
            </footer>
