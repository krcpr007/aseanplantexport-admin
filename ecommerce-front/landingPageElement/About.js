        ...
        <>
            <section className="relative px-4 py-16 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-32">
                <div className="flex flex-col lg:flex-row lg:-mx-8">
                    ...
                    <div className="w-full lg:w-1/2 lg:px-8 mt-12 lg:mt-0">
                        <div className="md:flex">
                            <div>
                                <div className="w-16 h-16 bg-[#9DE62A] rounded-full flex items-center justify-center">
                        ...
                        <div className="md:flex mt-8">
                            <div>
                                <div className="w-16 h-16 bg-[#9DE62A] rounded-full flex items-center justify-center">
                                <GiPlantsAndAnimals className="text-4xl" />
                                </div>
                            </div>
                            <div className="md:ml-8 mt-4 md:mt-0">
                                <h4 className="text-xl font-bold leading-tight">Our Plant-Focused Approach</h4>
                ...
                <div className="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
                    <div className="md:w-1/2 md:px-4 lg:w-1/4 object-cover">
                        <div className="bg-white rounded-lg border border-gray-300 p-8">
                            <Image src="/svg/experieance.svg" alt="" className="h-20 w-40 mx-auto object-cover" height={400} width={400} />
                    ...
                    <div className="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4 object-cover">
                        <div className="bg-white rounded-lg border border-gray-300 p-8">


                            <Image src="svg/top-quality.svg" alt="" className="h-20 w-40 mx-auto object-cover" height={400} width={400} />
                    ...
                    <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4 object-cover">
                        <div className="bg-white rounded-lg border border-gray-300 p-8">
                            <Image src="/svg/plant.svg" alt="" className="h-20 w-40 mx-auto object-cover" height={400} width={400} />

                            <h4 className="text-xl font-bold mt-4">All in one Service</h4>
                            <p className="mt-1">Very simplified service – one invoice.</p>
                            {/* <a href="#" className="block mt-4">Read More</a> */}
                        </div>
                    </div>
                    ...
                    <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4 object-cover">
                        <div className="bg-white rounded-lg border border-gray-300 p-8">
                            <Image src="/svg/No_minimum.svg" alt="" className="h-20 w-40 mx-auto object-cover" height={400} width={400}/>
