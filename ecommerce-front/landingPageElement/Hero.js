            ...
            >
                ...
                <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-12">
                    <div>
                        ...
                        <Link href="/products" className="px-8 py-4 bg-green-500 text-white rounded-full inline-block mt-8 font-semibold mr-2">Buy Plants</Link>
                        <a href="/account" className='px-8 py-4 bg-green-500 text-white rounded-full inline-block mt-8 font-semibold'>Create your account</a>
                    </div>
                </div>
            </section>
        </>
